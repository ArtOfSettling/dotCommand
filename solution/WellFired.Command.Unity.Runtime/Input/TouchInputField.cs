...
{
	internal class TouchInputField : IInputField
	{
		...
		public TouchInputField(LogHistoryGui logHistoryGuiView)
		{
		...
		{
			DevelopmentConsole.Instance.ForceMinimize = TouchScreenKeyboard.visible;
